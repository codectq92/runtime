"""
CDI generator for NewChip devices.

TODO: Replace placeholder device paths and logic with actual
      NewChip device node paths and mount configurations.
"""
...
class NewChipGenerator(Generator):
    """
    CDI generator for NewChip devices.
    """
    ...
    def generate(
        ...
        """
        Generate the CDI configuration for NewChip devices.
        ...
        Args:
            ...
            include_all_devices:
                Whether to include a device entry that represents all NewChip devices.
        ...
        # TODO: Replace with actual common device node paths for this chip.
        common_device_nodes = []
        for p in [
            "/dev/newchip_ctl",
        ]:
        ...
        for dev in devices:
            ...
            # TODO: Replace with actual per-device node path logic.
            cdn = device_to_cdi_device_node(
                path=f"/dev/newchip{dev.index}",
            )
            if not cdn:
                continue
